<x-layouts.admin>
    <x-slot name="title">Add Coupon</x-slot>
    ...
    <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1.25rem;">
        ...
        <h1 style="font-size: 1.125rem; font-weight: 600; color: #303030;">Create discount</h1>
    </div>
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 1rem;">
            <div style="display: flex; flex-direction: column; gap: 1rem;">
                ...
                <div class="card" style="padding: 1.25rem;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1rem;">
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                            <div>
                                ...
                                <input type="text" name="code" id="code" value="{{ old('code') }}" required
                                       class="form-input" style="font-family: monospace; text-transform: uppercase;" placeholder="e.g. SAVE20">
                                @error('code')
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                       class="form-input" placeholder="e.g. Summer Sale 20% Off">
                                @error('name')
                                    <p class="form-error">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="2" class="form-textarea" placeholder="Optional description...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="form-error">{{ $message }}</p>
                            @enderror
                        </div>

                        <div x-data="{ couponType: '{{ old('type', 'percentage') }}' }">
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                                <div>
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                                        <div>
                                            ...
                                            <input type="number" name="conditions[buy_qty]" id="conditions_buy_qty"
                                                   value="{{ old('conditions.buy_qty') }}" min="1" step="1"
                                        ...
                                        <div>
                                            ...
                                            <input type="number" name="conditions[get_qty]" id="conditions_get_qty"
                                                   value="{{ old('conditions.get_qty') }}" min="1" step="1"
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1rem;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                            ...
                            <div>
                                ...
                                <input type="number" name="usage_per_user" id="usage_per_user" value="{{ old('usage_per_user') }}" min="1"
                                       class="form-input" placeholder="Unlimited">
                ...
                <div class="card" x-data="productSearch" data-search-url="{{ route('admin.search.products') }}"
                     data-selected="{{ json_encode(old('applicable_products', []), JSON_HEX_APOS | JSON_HEX_QUOT) }}"
                     data-selected-names="{{ json_encode(new stdClass(), JSON_HEX_APOS | JSON_HEX_QUOT) }}"
                ...
                <div class="card" x-data="{
                    selected: @json(old('applicable_categories', [])),
                ...
                <div class="card" style="padding: 1.25rem;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1rem;">
                        <div>
                            ...
                            <input type="datetime-local" name="starts_at" id="starts_at" value="{{ old('starts_at') }}" class="form-input">
                            @error('starts_at')
                                <p class="form-error">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            ...
                            <input type="datetime-local" name="expires_at" id="expires_at" value="{{ old('expires_at') }}" class="form-input">
                            @error('expires_at')
                                <p class="form-error">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div style="display: flex; align-items: center; justify-content: flex-end; gap: 0.5rem; margin-top: 1.25rem; padding-top: 1rem; border-top: 1px solid #e3e3e3;">
                ...
                <button type="submit" class="btn btn-primary" style="font-size: 13px;">Create coupon</button>
            </div>
    </form>
