<x-layouts.seller>
    <x-slot name="title">New Coupon</x-slot>
    ...
    <h1 class="text-2xl font-bold text-neutral-900 mb-6">Create Coupon</h1>

    <form action="{{ route('seller.coupons.store') }}" method="POST" class="max-w-2xl">
        @csrf
