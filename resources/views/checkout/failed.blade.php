            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <a href="{{ route('checkout.index') }}"
                       class="flex-1 inline-flex items-center justify-center gap-2 py-3 px-6 bg-[#7a1f2b] hover:bg-[#5f1721] text-white text-sm font-semibold rounded-xl transition-colors">
                ...
                <div class="mt-8 text-center">
                    <p class="text-xs text-neutral-600">
                        Need help? <a href="{{ route('contact') }}" class="text-[#c9a227] hover:underline">Contact our support team</a>
                    </p>
                </div>
