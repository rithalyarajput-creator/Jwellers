            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-10">
                ...
                <div class="col-span-2 lg:col-span-2">
                    <a href="{{ url('/') }}" class="flex items-center gap-2 mb-4">
                        @php
                            ...
                            $footerAbout = \App\Models\Setting::get('footer_about', 'Exquisite handcrafted jewellery for every occasion. Discover timeless gold, diamond, and silver pieces with Jwellers.');
                        @endphp
                        @if($footerLogo)
                            <img src="{{ asset('storage/' . $footerLogo) }}" alt="{{ config('app.name') }}" class="h-10 object-contain brightness-0 invert">
                        @else
                            <img src="{{ asset('images/colorlogo.png') }}" alt="Jwellers" class="h-10 object-contain brightness-0 invert">
                        @endif
                    </a>
                    ...
                    <div class="flex gap-3">
                        ...
                        @endphp
                        @if($socialFacebook)
                            <a href="{{ $socialFacebook }}" class="w-9 h-9 bg-white/10 hover:bg-[#c9a227] text-white/70 hover:text-white rounded-full flex items-center justify-center transition-all" aria-label="Facebook" target="_blank">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                            </a>
                        @endif
                        @if($socialInstagram)
                            <a href="{{ $socialInstagram }}" class="w-9 h-9 bg-white/10 hover:bg-[#c9a227] text-white/70 hover:text-white rounded-full flex items-center justify-center transition-all" aria-label="Instagram" target="_blank">
                        ...
                        @endif
                        @if($socialYoutube)
                            <a href="{{ $socialYoutube }}" class="w-9 h-9 bg-white/10 hover:bg-[#c9a227] text-white/70 hover:text-white rounded-full flex items-center justify-center transition-all" aria-label="YouTube" target="_blank">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                            </a>
                        @endif
                        @if($socialTiktok)
                            <a href="{{ $socialTiktok }}" class="w-9 h-9 bg-white/10 hover:bg-[#c9a227] text-white/70 hover:text-white rounded-full flex items-center justify-center transition-all" aria-label="TikTok" target="_blank">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li><a href="{{ route('about') }}" class="text-neutral-200 hover:text-[#c9a227] transition-colors">About Us</a></li>
                        <li><a href="{{ route('contact') }}" class="text-neutral-200 hover:text-[#c9a227] transition-colors">Contact Us</a></li>
                        <li><a href="{{ route('faq') }}" class="text-neutral-200 hover:text-[#c9a227] transition-colors">FAQs</a></li>
                        <li><a href="{{ route('blog') }}" class="text-neutral-200 hover:text-[#c9a227] transition-colors">Blog</a></li>

                        <li><a href="{{ route('size-guide') }}" class="text-neutral-200 hover:text-[#c9a227] transition-colors">Size Guide</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li><a href="{{ route('help') }}" class="text-neutral-200 hover:text-[#c9a227] transition-colors">Help Center</a></li>
                        <li><a href="{{ route('track-order') }}" class="text-neutral-200 hover:text-[#c9a227] transition-colors">Track Order</a></li>
                        <li><a href="{{ route('returns') }}" class="text-neutral-200 hover:text-[#c9a227] transition-colors">Returns & Refunds</a></li>
                        <li><a href="{{ route('shipping') }}" class="text-neutral-200 hover:text-[#c9a227] transition-colors">Shipping Info</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li><a href="{{ route('privacy') }}" class="text-neutral-200 hover:text-[#c9a227] transition-colors">Privacy Policy</a></li>
                        <li><a href="{{ route('terms') }}" class="text-neutral-200 hover:text-[#c9a227] transition-colors">Terms of Service</a></li>
                        <li><a href="{{ route('cookie-policy') }}" class="text-neutral-200 hover:text-[#c9a227] transition-colors">Cookie Policy</a></li>
                        <li><a href="{{ route('gdpr') }}" class="text-neutral-200 hover:text-[#c9a227] transition-colors">GDPR Compliance</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="max-w-xl mx-auto text-center" x-data="{ email: '', submitted: false, error: '' }">
                ...
                " class="flex items-stretch gap-2 max-w-md mx-auto" aria-label="Newsletter subscription">
                    ...
                    <input id="newsletter-email" type="email" x-model="email" required placeholder="Your email address"
                           ...
                           class="flex-1 min-w-0 text-sm px-4 py-2.5 bg-white/10 border border-white/20 rounded-lg text-white placeholder-neutral-300 focus:outline-none focus:border-[#c9a227]">
                    <button type="submit" class="shrink-0 text-sm font-semibold bg-[#7a1f2b] hover:bg-[#5f1721] text-white px-5 py-2.5 rounded-lg transition-colors">
                        Subscribe
                    </button>
                </form>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-center gap-3">
                <p class="text-xs text-neutral-200">
                    &copy; {{ date('Y') }} {{ \App\Models\Setting::get('site_name', 'Jwellers') }}. All rights reserved.
                </p>
