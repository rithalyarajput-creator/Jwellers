<x-layouts.admin>
    ...
    <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1.25rem;">
        ...
        <h1 style="font-size: 1.125rem; font-weight: 600; color: #303030;">Add location</h1>
    </div>
    ...
    <form action="{{ route('admin.inventory.locations.store') }}" method="POST">
        ...
        <div class="card" style="max-width: 640px; margin-top: 1rem; padding: 1.25rem;">
            ...
            <div style="display: flex; flex-direction: column; gap: 1rem;">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                           class="form-input" placeholder="e.g. Main Warehouse">
                    @error('name')
                ...
                <div>
                    ...
                    <input type="text" name="code" value="{{ old('code') }}" required
                           class="form-input" placeholder="e.g. WH-001">
                    @error('code')
                        <p class="form-error">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="address" rows="2" class="form-textarea" placeholder="Full address...">{{ old('address') }}</textarea>
                    @error('address')
                        <p class="form-error">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div style="display: flex; align-items: center; justify-content: flex-end; gap: 0.5rem; margin-top: 1.25rem; padding-top: 1rem; border-top: 1px solid #e3e3e3;">
                ...
                <button type="submit" class="btn btn-primary" style="font-size: 13px;">Save location</button>
            </div>
    </form>
</x-layouts.admin>
