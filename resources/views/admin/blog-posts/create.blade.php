<x-layouts.admin>
    ...
    <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1.25rem;">
        ...
        <h1 style="font-size: 1.125rem; font-weight: 600; color: #303030;">Add blog post</h1>
    </div>
    ...
    <form action="{{ route('admin.blog-posts.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 1rem;">
                ...
                <div class="card" style="padding: 1.25rem;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1rem;">
                        ...
                        <div>
                            ...
                            <p style="font-size: 12px; color: #616161; margin-top: 0.25rem;">Leave empty to auto-generate</p>
                        ...
                        <div>
                            ...
                            <p style="font-size: 12px; color: #616161; margin-top: 0.25rem;">Max 500 characters</p>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1rem;">
                        <div>
                            ...
                            <input type="text" name="seo_data[meta_title]" value="{{ old('seo_data.meta_title') }}"
                                   class="form-input" placeholder="SEO title (defaults to post title)">
                        </div>
                        <div>
                            <label class="form-label">Meta Description</label>
                            <textarea name="seo_data[meta_description]" rows="2" class="form-textarea"
            ...
            <div style="display: flex; flex-direction: column; gap: 1rem;">
                ...
                <div class="card" style="padding: 1.25rem;">
                    ...
                    <label style="display: flex; align-items: center; gap: 0.75rem; cursor: pointer;">
                        ...
                        <div>
                            <span style="font-size: 13px; font-weight: 500; color: #303030;">Publish immediately</span>
                            <p style="font-size: 12px; color: #616161;">Unchecked = saved as draft</p>
                        </div>
                    </label>
                </div>
                ...
                <div class="card" style="padding: 1.25rem;">
                    ...
                    <p style="font-size: 12px; color: #616161; margin-top: 0.25rem;">JPG, PNG, WebP. Max 2MB.</p>
            ...
            <div style="display: flex; align-items: center; justify-content: flex-end; gap: 0.5rem; margin-top: 1.25rem; padding-top: 1rem; border-top: 1px solid #e3e3e3;">
                ...
                <button type="submit" class="btn btn-primary" style="font-size: 13px;">Save post</button>
            </div>
    </form>
